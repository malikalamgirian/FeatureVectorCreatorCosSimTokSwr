...
public class MonotonicFeatureSelector {
    ...
    private void process() throws Exception {
        ...
        NodeList pairs,
                ...
                CosineSimilarityTokSwr_NodeList,
...
//             Get the required one
            CosineSimilarityTokSwr_NodeList = root.getElementsByTagName("CosineSimilarityTokSwr");
            ...
            for (int i = 0; i < pairs.getLength(); i++) {
                ...
                /*
                 * Extract CosineSimilarityTokSwr value
                 */
                CosineSimilarityTokSwr_String = CosineSimilarityTokSwr_NodeList.item(i).getTextContent();
                ...
                if (i == 0) {
                     ...
                     * 
                     *
                     * String1Id,String2Id,CosineSimilarityTokSwr,pair_Quality
                     */
                    line_To_Insert_In_File = "String1Id,"
                            + "String2Id,"
                            + "CosineSimilarityTokSwr,"
                            + "pair_Quality";
                 ...
                 */
                line_To_Insert_In_File = appendString(line_To_Insert_In_File, CosineSimilarityTokSwr_String, feature_Separator_Char);
